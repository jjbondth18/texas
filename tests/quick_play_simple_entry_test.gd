...
func _init() -> void:
	...
	_require(source.contains("Quickly join the best available public chip table with your selected stakes."), "Quick Chip must describe selected stakes")
	_require(source.contains("If no matching table is available, a new public table will be created."), "Quick Chip must describe no-match creation")
