...
func _init() -> void:
	...
	_require(PlayerProfileScript.get_total_chips(after) == 2500, "confirm purchase path should deduct chips.")
	ProfileServiceScript.reset_mock_profile()
	print("Avatar purchase confirm deducts chips test passed.")
	quit(0)
