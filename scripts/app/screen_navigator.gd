...
static func open_poker_table(tree: SceneTree, launch_mode: String = "quick_play", table_id: String = "mock_table_001") -> void:
	TableLaunchContextScript.configure(launch_mode, table_id)
