...
func _ready() -> void:
	...
	# Custom tab container theme override to blend in
	var tab_style_empty := StyleBoxEmpty.new()
	tab_container.add_theme_stylebox_override("panel", tab_style_empty)
	...
	tab_container.add_child(chat_vbox)
